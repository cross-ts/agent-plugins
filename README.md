...
```bash
claude plugin marketplace add git@github.com:cross-ts/agent-plugins.git
```

### Codex CLI

```bash
codex plugin marketplace add git@github.com:cross-ts/agent-plugins.git
```
...
```bash
copilot plugin marketplace add git@github.com:cross-ts/agent-plugins.git
```
